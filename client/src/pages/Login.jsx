...
import {Box,Grommet,grommet,Button,TextInput,Form,Anchor,Heading,Text} from 'grommet'
                ...
                <Box background='light-3' round='medium' pad='medium' elevation='large'  border={{color:'none',size:'xsmall'}}>
                    <Form onSubmit={login} >
                            ...
                            <Box margin='medium' direction='row' align='center'  round='medium' border>
                                <TextInput plain name="Password" required={true} placeholder='Password' type={reveal ? 'text' : 'password'}/>
